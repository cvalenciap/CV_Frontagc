...
@Component({
  selector: 'app-cumplimiento-actividad-cierre',
  templateUrl: './cumplimiento-actividad-cierre.component.html',
  styleUrls: ['./cumplimiento-actividad-cierre.component.scss']
})
export class CumplimientoActividadCierreComponent implements OnInit {
