  ...
  validarFormulario(filtros: FiltrosBandejaMonitoreo) {
    ...
    if ( filtros.contratista.codigo && filtros.oficina.codigo ) {
      if(filtros.suministro && !Number(filtros.suministro)){
        ...
        valida = false;
        this.toastr.warning("El Número de Orden de Servicio debe estar compuesto solo de números.", Mensajes.CAB_MESSAGE_AVISO, { closeButton: true });
      }
  ...
  validarFormularioDetalle(filtros: FiltrosBandejaMonitoreoDetalle) {
    ...
    private mostrarInformacionFiltrosDetalle() {
      ...
      if (this.filtrosBusquedaDetalle.tipoInspeccion) {
        mensaje = mensaje + '<br/><strong>Tipo de Inspección: </strong> <parrafo>' + this.filtrosBusquedaDetalle.tipoInspeccion.detalle + '</parrafo>' + ' ';
        this.mostrarFiltrosDetalle = true;
      }
      ...
      if (this.filtrosBusquedaDetalle.resultadoInspeccion) {
        mensaje = mensaje + '<br/><strong>Resultado de Inspección: </strong> <parrafo>' + this.filtrosBusquedaDetalle.resultadoInspeccion.detalle + '</parrafo>' + ' ';
        this.mostrarFiltrosDetalle = true;
      }
