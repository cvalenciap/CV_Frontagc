...
import { DistribucionComunicaciones } from "src/app/models/distribucionComunicaciones";

@Component({
  selector: 'app-detalle-carga-distribucion-comunicaciones',
  templateUrl: './detalle-carga-distribucion-comunicaciones.component.html'
})
export class DetalleCargaDistribucionComunicacionesComponent implements OnInit {
  ...
  /* Lista de tareas */
  listaItems: DistribucionComunicaciones[];
  ...
  obtenerDetalleTrabajo(): void {
    this.service.obtenerDetalleTrabajoDistribucionComunicaciones(this.itemCargaTrabajo.uidCargaTrabajo, this.codigoRegistro, this.paginacion).subscribe(
