...
@Component({
  selector: 'app-detalle-carga-toma-estados',
  templateUrl: './detalle-carga-toma-estados.component.html'
})
export class DetalleCargaTomaEstadosComponent implements OnInit {
  @Input() itemCargaTrabajo: CargaTrabajo;
  /* Objeto para paginación */
  paginacion: Paginacion;
  /* Lista de tareas */
  @Input()
  listaItems: TomaEstados[];
  ...
  obtenerDetalleTrabajo(): void {
    this.service.obtenerDetalleTrabajoTomaEstados(this.itemCargaTrabajo.uidCargaTrabajo, this.codigoRegistro, this.paginacion).subscribe(
