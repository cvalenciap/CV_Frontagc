...
import { InspeccionesComerciales } from "src/app/models/inspeccionesComerciales";

@Component({
  selector: 'app-detalle-carga-inspecciones-comerciales',
  templateUrl: './detalle-carga-inspecciones-comerciales.component.html'
})
export class DetalleCargaInspeccionesComercialesComponent implements OnInit {
  @Input() itemCargaTrabajo: CargaTrabajo;
  /* Objeto para paginación */
  paginacion: Paginacion;
  /* Lista de tareas */
  listaItems: InspeccionesComerciales[];
  ...
  obtenerDetalleTrabajo(): void {
    this.service.obtenerDetalleTrabajoInspeccionesComerciales(this.itemCargaTrabajo.uidCargaTrabajo, this.codigoRegistro, this.paginacion).subscribe(
